...
from metadrive.utils.math import get_vertical_vector, norm
...
class InterpolatingLine:
    ...
    def get_point(self, longitudinal, lateral=None):
        ...
        if lateral is not None:
            return (
                seg["start_point"] + (longitudinal - accumulate_len + seg["length"]) * seg["direction"]
            ) + lateral * seg["lateral_direction"]
        else:
...
if __name__ == "__main__":
    test_p = [
        (611.5277397744468, 1829.6026943481352),
