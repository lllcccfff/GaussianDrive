...
import remote_viewer_pb2 as remote__viewer__pb2


class OnsiteViewerServiceStub(object):
...
def add_OnsiteViewerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'onsite.viewer.OnsiteViewerService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class OnsiteViewerService(object):
    """Missing associated documentation comment in .proto file."""
