...
if __name__ == "__main__":
    ...
    # Monkey patch load data
    model_load_data = model.load_metadata

    def new_model_load_data(path):
        cfg = Config.fromfile(filename=path)
        return cfg, *model_load_data(cfg)

    model.load_metadata = new_model_load_data
