...
from metadrive.third_party.kitsunetsuki.base.material import get_from_node, get_root_node
...
class MaterialMixin(object):
    def make_material(self, material):
        ...
        gltf_material["alphaMode"] = {"OPAQUE": "OPAQUE", "BLEND": "BLEND", "CLIP": "MASK"}.get(
