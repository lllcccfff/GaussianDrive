...
def main():
    ...
    from metadrive.third_party.kitsunetsuki.exporter.vrm import VRMExporter
...
def register(init_version):
    ...
    from metadrive.third_party.kitsunetsuki.exporter.vrm import VRMExporterOperator, export
