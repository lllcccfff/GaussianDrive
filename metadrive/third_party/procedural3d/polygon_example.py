...
class MyApp(ShowBase):
    def __init__(self):
        ...
        p_light.set_color((1.0, 1.0, 1.0, 1.0))
        self.light = self.camera.attach_new_node(p_light)
        self.light.set_pos(0.0, 10.0, 0.0)
        ...
        points = [
            ...
            [234.17903486, -71.70488153],
            [233.22807516, -64.56937753],
            [232.70516199, -60.43428241],
            [230.06360069, -58.76593274],
            [226.86714349, -57.3599948],
            [222.64706585, -53.10916339],
            [218.20545033, -48.79186],
            [219.96329603, -46.58656909],
            [224.27795345, -50.88911069],
            [227.92423276, -54.4945615],
            [231.56956222, -57.75740367],
            [235.59826439, -61.20357757],
            [235.19689215, -62.43117443],
            [234.1779322, -61.86125077],
            [234.68204325, -64.88105623],
            [235.55523041, -71.68052],
            [236.70966602, -79.94476767],
        ]
